...
namespace API.Migrations
{
    ...
    [Migration("20240128094620_GenresCreateDate")]
    partial class GenresCreateDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.CinemaOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.Keyless.CinemaWithoutLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.Keyless.MovieWithCounts", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.CinemaOffer", b =>
                {
                    b.HasOne("API.Entities.Cinema", null)
                        .WithOne("CinemaOffer")
            ...
            modelBuilder.Entity("CinemaHallMovie", b =>
                {
                    b.HasOne("API.Entities.CinemaHall", null)
                        .WithMany()
